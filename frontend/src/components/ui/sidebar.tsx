...
function SidebarProvider({
  ...
  const fetchConversations = React.useCallback(async () => {
    ...
    try {
      const response = await fetch('/api/chat/conversation/all', { credentials: 'include' })
      if (response.ok) {
  ...
  }), [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, conversations, fetchConversations])
